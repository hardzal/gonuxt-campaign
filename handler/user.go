...
func (h *userHandler) RegisterUser(c *gin.Context) {
	...
	if err != nil {
		response := helper.APIResponse("Failed to getting token", http.StatusBadRequest, "error", nil)
		c.JSON(http.StatusBadRequest, response)
		return
	}
...
func (h *userHandler) Login(c *gin.Context) {
	...
	if err != nil {
		response := helper.APIResponse("Failed to getting token login", http.StatusBadRequest, "error", nil)
		c.JSON(http.StatusBadRequest, response)
		return
	}
